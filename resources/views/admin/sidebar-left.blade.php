...
<section class="sidebar">
  ...
  <ul class="sidebar-menu" data-widget="tree">
    ...
    <li class="treeview">
      ...
      <ul class="treeview-menu">
        ...
        <li class="treeview active">
              <a href="#"><i class="fa fa-dropbox text-green"></i> Item
    ...
    <li><a href="{{ route('barcode.index')}}"><i class="fa fa-barcode"></i> <span>Cetak Barcode</span></a></li>
    ...
    <li class="treeview">
      ...
      <ul class="treeview-menu">
        <li class="treeview">
              <a href="#"><i class="fa fa-dropbox"></i> More
                <span class="pull-right-container">
                  <i class="fa fa-angle-left pull-right"></i>
                </span>
              </a>
    ...
    <li><a href="{{ route('pinjam.index') }}"><i class="fa fa-arrow-circle-up text-red"></i> <span>Pinjam Buku</span></a></li>
    <li><a href="{{ route('kembali.index') }}"><i class="fa fa-arrow-circle-down text-green"></i> <span>Pengembalian Buku</span></a></li>
