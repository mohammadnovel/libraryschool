...
<link rel="stylesheet" href="{{ url('assets/bower_components/select2/dist/css/select2-bootstrap.css')}}">
...
<script
 src="{{ url('assets/bower_components/datatables.net-bs/js/dataTables.bootstrap.min.js')}}"></script>
